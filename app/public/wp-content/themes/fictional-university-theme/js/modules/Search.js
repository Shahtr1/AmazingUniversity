...
class Search {
	...
	//keydown runs again and again fires very fast that it doesnt give any body time to update
	//keyup run once

	// 2. events
	events(){
		// .bind to point towards our object of Search and by default the on method sets "this" to whatever element triggered this event
	...
	getResults(){
		...
		/*
		//all will run asynchronously in when, after completing all it moves on and calls then method
		$.when(
			...
			<div class="search-overlay">
			  <div class="search-overlay__top">
			    <div class="container">
			      ...
			      <i class="fa fa-window-close search-overlay__close" aria-hidden></i>
			    </div>
			  </div>
